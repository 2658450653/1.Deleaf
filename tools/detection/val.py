...
from modules.Detection.Detect import DetectMultiBackend
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/dota_test.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/yolov5s_4small/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='yolov5s_4small', help='save to project/name')
