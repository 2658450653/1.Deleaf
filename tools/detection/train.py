...
from modules.experimental import attempt_load
from tools.detection.yolo import Model
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'cfg/entirety/detection/yolov5m_blenderv3', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'cfg/data/dota_test.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'cfg/hyper/obb/hyp.finetune_dota.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='yolov5m_sconcate', help='save to project/name')
